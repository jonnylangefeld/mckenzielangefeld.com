...
echo "Starting deploy to https://mckenzielangefeld.com"
...
# Bots need names too
git config --global user.email "jekyllbot@mckenzielangefeld.com"
git config --global user.name "Jekyll-Bot"

# Delete old directories (if any)
rm -rf "/tmp/mckenzielangefeld.com"
# Copy the generated website to the temporary directory
cp -R "_site/" "/tmp/mckenzielangefeld.com"
